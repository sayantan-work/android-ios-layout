...
SCREENS['apply-request'] = {
  ...
  render: () => {
    ...
    return `
      ...
      ${settingsList(types)}
      <p class="note" style="margin:14px 8px 0;font-size:11px;color:var(--muted-2);line-height:1.55">All requests route to your reporting manager. You'll get a notification once they're reviewed.</p>
    `;
  }
};
