...
const punchHero = () => `
  ...
  <div class="elapsed" style="max-width:230px;margin:12px auto 8px">
    ...
    <div class="elapsed-labels" style="justify-content:flex-end"><span style="font-feature-settings:'tnum'"><b>7h 36m</b> <span style="color:var(--muted-2)">/ 9h</span></span></div>
  </div>
...
const meScreen = (p) => {
  ...
  return `
    ...
    ${!isProd ? `
      ...
      <div class="settings-row"><div class="list-icon">${I('i-card')}</div>
        <div class="settings-body"><div class="settings-title">My Requests</div><div class="settings-meta">12 approved · 2 pending</div></div>${I('i-chev-r')}</div>
      <div class="settings-row"><div class="list-icon">${I('i-rupee')}</div>
        <div class="settings-body"><div class="settings-title">My Salary Slips</div><div class="settings-meta">5 months</div></div>${I('i-chev-r')}</div>
      <div class="settings-row"><div class="list-icon">${I('i-cal-sub')}</div>
